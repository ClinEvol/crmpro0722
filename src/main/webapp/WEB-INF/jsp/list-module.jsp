                   ...
                   <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <select class="selectpicker form-control">
                                    ...
                                    <option  value="1"  <c:if test="${type==1}">selected</c:if> >模块名称</option>
                            ...
                            <div class="col-sm-2 text-right">
                            		<a href="/module/tosave" class="btn btn-sm btn-primary" type="button"><i class="fa fa-plus-circle"></i> 添加模块</a>
                            	</div>
                            </form>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
	                                        	...
	                                        	<a href="/module/toupdate?id=${module.id}"><i class="glyphicon glyphicon-edit  text-navy"></i></a>
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-7 text-right">
                               <div class="btn-group">
                                   <a href="/module/list?pageNum=${page.pageNum-1}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum-1<1}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-left"></i></a>
                                   <c:forEach begin="1" end="${page.pages}" varStatus="index">
                                       <a href="/module/list?pageNum=${index.index}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum==index.index}">active</c:if> ">${index.index}</a>
                                   </c:forEach>
                                   <a href="/module/list?pageNum=${page.pageNum+1}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum+1>page.pages}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-right"></i></a>
                               </div>
                           </div>
                       </div>
