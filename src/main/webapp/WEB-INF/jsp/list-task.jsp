                   ...
                   <div class="ibox-content">
                            ...
                            <table class="table table-striped list-table">
                                ...
                                <c:forEach items="${list}" var="task">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="show-task.html"><i class="glyphicon glyphicon-eye-open  text-navy"></i></a>
                                            <c:if test="${task.status!=2}">
                                            <a href="table_basic.html#"><i class="glyphicon glyphicon-edit  text-navy"></i></a>
                        ...
                        <div class="row">
							...
							<div class="col-sm-7 text-right">
                                <div class="btn-group">
                                    <a href="/task/list?pageNum=${page.pageNum-1}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum-1<1}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-left"></i></a>
                                    <c:forEach begin="1" end="${page.pages}" varStatus="index">
                                        <a href="/task/list?pageNum=${index.index}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum==index.index}">active</c:if> ">${index.index}</a>
                                    </c:forEach>
                                    <a href="/task/list?pageNum=${page.pageNum+1}&keyword=${keyword}&type=${type}" class="btn btn-sm btn-white <c:if test="${page.pageNum+1>page.pages}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-right"></i></a>
                                </div>
							</div>
                        </div>
